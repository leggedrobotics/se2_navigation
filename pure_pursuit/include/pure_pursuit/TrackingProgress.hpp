...
class TrackingProgress
{
 ...
 public:
  ...
  virtual bool isPathSegmentTrackingFinished(const PathSegment &pathSegment,
                                             const RobotState &currentState);
  virtual bool isPathTrackingFinished(const Path &pathSegment, const RobotState &currentState,
                                      unsigned int currentSegmenet);
