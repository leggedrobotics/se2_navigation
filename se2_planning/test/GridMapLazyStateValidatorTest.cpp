...
TEST(LazyStateValidator, GridMapTest1) {
  std::function<bool(double, double)> isAnObstacle = [](double x, double y) { return x > 0.0 && y > 0.0; };
  ...
  auto validator = se2_planning::createGridMapLazyStateValidator(gridMap, se2_planning::computeFootprint(1.0, 0.0, 0.5, 0.5), testLayer);
...
TEST(LazyStateValidator, GridMapTest2) {
  ...
  validator = se2_planning::createGridMapLazyStateValidator(gridMap, se2_planning::computeFootprint(1.0, 0.0, 0.5, 0.5), testLayer);
...
TEST(LazyStateValidator, RandomCollisionChecking) {
  ...
  if (::testing::Test::HasFailure()) {
    std::cout << "\n Test LazyStateValidator, RandomCollisionChecking failed with seed: " << seed << std::endl;
  }
}
...
TEST(LazyStateValidator, EarlyStopping) {
  ...
  if (::testing::Test::HasFailure()) {
    std::cout << "\n Test LazyStateValidator, EarlyStopping failed with seed: " << seed << std::endl;
  }
}
...
TEST(LazyStateValidator, HeuristidAndRandom) {
  ...
  if (::testing::Test::HasFailure()) {
    std::cout << "\n Test LazyStateValidator, HeuristidAndRandom failed with seed: " << seed << std::endl;
  }
}
